              ...
              <div className="w-full max-w-[260px] min-h-[340px] max-h-[380px] bg-white border border-gray-250/70 rounded-[24px] p-5 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between text-left group">
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {[
                      { icon: <Settings size={14} className="text-amber-500" />, label: "Coordination" },
                      { icon: <Users size={14} className="text-amber-500" />, label: "Workforce" },
                      { icon: <ShieldCheck size={14} className="text-amber-500" />, label: "Standards" },
                      { icon: <IndianRupee size={14} className="text-amber-500" />, label: "Clear Pricing" }
                    ].map((chip, idx) => (
