...
export default function Hero() {
  ...
  return (
    <section className="relative w-full min-h-[calc(100vh-84px)] lg:min-h-[calc(100vh-84px)] flex flex-col justify-between px-6 md:px-12 lg:px-20 py-6 lg:py-0 overflow-hidden">
      ...
      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center flex-1">
        ...
        <div className="lg:col-span-7 flex flex-col items-start text-left z-10 py-8 lg:py-16">
          ...
          {/* Heading */}
          <h1 className="font-sans font-black tracking-tight text-[#111111] text-[40px] sm:text-[52px] md:text-[60px] lg:text-[68px] xl:text-[76px] leading-[1.1] mb-6 animate-fade-in-up">
            Household Help, <br />
            <span className="relative inline-block my-2 sm:my-3 max-w-full">
              <span className="relative z-10 text-deep-black px-4 sm:px-6 bg-[#00D2C4] rounded-[16px] sm:rounded-[20px] inline-block py-1 sm:py-2 shadow-sm whitespace-normal">
