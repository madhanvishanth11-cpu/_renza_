...
export default function TrustSection() {
  ...
  return (
    <section style={{ scrollMarginTop: '84px' }} className="w-full bg-bg-light transition-colors duration-300 py-8 lg:py-16 border-t border-gray-200" id="safety">
      <div className="w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        >
          <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-yellow/10 border border-brand-yellow/30 text-text-dark text-[17px] md:text-[20px] lg:text-[24px] font-bold tracking-wider uppercase mb-4">
            <ShieldCheck size={20} className="text-amber-500 fill-amber-500" />
            WHY TRUST RENZA?
          </span>
        ...
        <div 
          ref={cardsRef}
          className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 lg:mb-8 lg:mb-10 transition-all duration-1000 transform ${
